...
import com.relesi.modernizationbiometric.api.dtos.CadastroPFDto;
...
public class CadastroPFController {
	...
	/**
	 * Cadastra um funcionário pessoa fisíca no sistema.
	 * 
	 * @param CadastroPFDto
	 * @param result
	...
	private Funcionario converterDtoParaFuncionario(CadastroPFDto cadastroPFDto, BindingResult result)
		...
		cadastroPFDto.getQtdHorasTrabalhoDia()
				.ifPresent(qtdHoraTrabDia -> funcionario.setQtdHorasTrabalhoDia(Float.valueOf(qtdHoraTrabDia)));
